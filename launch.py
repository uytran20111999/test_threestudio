...
def main(args, extras) -> None:
    ...
    if cfg.system_type == "prolificdreamer_multi-system":
        # config_copy = cfg.system.copy()
        # del config_copy.n_particles
        compose_nerf = [threestudio.find('prolificdreamer-system')(cfg.system, resumed = False) for _ in range(cfg.system.n_particles)]
        system.init_n_prolific(compose_nerf)
        # system = threestudio.find('prolificdreamer-system')(cfg.system, resumed = False)
